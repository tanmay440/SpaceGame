    ...
    private void Update() {
        ...
        if (Input.GetMouseButtonDown(0)) {
            ...
            if (Physics.Raycast(ray, out hit))
            {
                ...
                // hit.transform.GetComponent<MarchingSquaresTerraingen>().PlaceTerrain(hit.point);
        ...
        if (Input.GetMouseButtonDown(1)) {
            ...
            if (Physics.Raycast(ray, out hit))
            {
                ...
                if (hit.transform.tag == "Terrain") ;
                // hit.transform.GetComponent<MarchingSquaresTerraingen>().RemoveTerrain(hit.point);
